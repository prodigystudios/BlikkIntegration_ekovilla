...
// ── Text ─────────────────────────────────────────────────────────────────────
//
// Flyttade till lib/pdf/text.ts 2026-09-21 när löneunderlagets PDF behövde samma radbrytning.
...
// ── Filer ────────────────────────────────────────────────────────────────────
//
// Typsnitten och logotypen flyttade till lib/pdf/brandAssets.ts 2026-09-21, när löneunderlagets
// PDF behövde samma filer utan att dra in hela den här modulen i sin serverfunktion.
// Re-exporterade här: routerna och testerna hämtar dem fortfarande härifrån.
export { loadDesignFonts, loadDesignLogo } from '@/lib/pdf/brandAssets';
