        ...
        <div className="grid gap-3.5">
          ...
          <label className="grid gap-1.5">
            ...
            <textarea
              ...
              className="min-h-24 w-full resize-y rounded-lg border border-[#dce4d8] bg-white px-3 py-2 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-[color:var(--crm-accent)] focus:ring-2 focus:ring-[color:var(--crm-accent-ring)]"
          ...
          <label className="flex items-center gap-2.5 rounded-xl border border-[#e0e8dc] bg-[#f6f9f3] px-3.5 py-3 text-sm font-semibold text-slate-700">
            <input
              type="checkbox"
              className="h-4 w-4 accent-[color:var(--crm-accent)]"
            ...
            <div className="grid max-h-[260px] gap-2 overflow-auto">
              {(publishMeta?.users || []).map((user) => (
                <label key={user.id} className="flex items-start gap-2.5 rounded-lg border border-[#e3e9df] bg-white px-2.5 py-2">
                  <input
                    type="checkbox"
                    className="mt-0.5 h-4 w-4 accent-[color:var(--crm-accent)]"
            ...
            <div className="grid max-h-[260px] gap-2 overflow-auto">
              {(publishMeta?.tags || []).map((tag) => (
                <label key={tag} className="flex items-start gap-2.5 rounded-lg border border-[#e3e9df] bg-white px-2.5 py-2">
                  <input type="checkbox" className="mt-0.5 h-4 w-4 accent-[color:var(--crm-accent)]" checked={publishUi.selectedTags.includes(tag)} onChange={() => onToggleTag(tag)} />
