...
export const CRM_NAV_ITEMS: CrmNavItem[] = [
  ...
  { href: '/crm/kunder', label: 'Kunder', description: 'Kundregister och historik', roles: ['sales', 'admin'] },
  { href: '/crm/prospekt', label: 'Prospekt', description: 'Potentiella kunder och leads', roles: ['sales', 'admin'] },
