...
export default function KorjournalTripModal({
  ...
  return (
    ...
    >
      <form id="korjournal-trip-form" onSubmit={(e) => { e.preventDefault(); onSubmit(); }} className="grid gap-3">
        {error ? (
        ...
        <div className={crm.cardInner}>
          <p className={cn('mb-3', crm.sectionTitle)}>Resa</p>
        ...
        <div className={crm.cardInner}>
          <p className={cn('mb-3', crm.sectionTitle)}>Mätarställning</p>
        ...
        <div className={crm.cardInner}>
          ...
          <textarea
            className="min-h-24 w-full resize-y appearance-none rounded-lg border border-[#dce4d8] bg-white px-3 py-2 text-sm text-slate-900 transition-colors placeholder:text-slate-400 hover:border-[#c8d4c3] focus:border-[color:var(--crm-accent)] focus:outline-none focus:ring-2 focus:ring-[color:var(--crm-accent-ring)]"
            value={form.note}
