          ...
          <div className="grid gap-3.5">
            <div className={PANEL}>
              ...
              <label className="mt-3.5 flex cursor-pointer items-center justify-between gap-3">
                ...
                <input type="checkbox" checked={truck.active} onChange={(e) => patchLocal(truck.id, { active: e.target.checked })} className="h-4 w-4 accent-[color:var(--crm-accent)]" />
              </label>
          ...
          <div className="grid gap-3.5">
            <div className={PANEL}>
              ...
              <label className="mt-3.5 flex cursor-pointer items-center justify-between gap-3">
                ...
                <input type="checkbox" checked={depot.active} onChange={(e) => patchLocal(depot.id, { active: e.target.checked })} className="h-4 w-4 accent-[color:var(--crm-accent)]" />
              </label>
              <button onClick={onSave} disabled={busy} className={cn(crm.formButton, 'mt-3.5')} style={{ backgroundColor: 'var(--crm-primary)' }}>Spara</button>
            </div>
        ...
        !jt ? (
          ...
          <div className="grid gap-3.5">
            <div className={PANEL}>
              ...
              <label className="mt-3.5 flex cursor-pointer items-center justify-between gap-3">
                <span className="text-[12.5px] font-bold text-slate-800">Aktiv</span>
                <input type="checkbox" checked={jt.active} onChange={(e) => patchLocal(jt.id, { active: e.target.checked })} className="h-4 w-4 accent-[color:var(--crm-accent)]" />
              </label>
              <button onClick={onSave} disabled={busy} className={cn(crm.formButton, 'mt-3.5')} style={{ backgroundColor: 'var(--crm-primary)' }}>Spara</button>
            </div>
            <div className={PANEL}>
