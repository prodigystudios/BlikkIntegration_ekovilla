      ...
      {canWrite &&
        (adding ? (
          <input
            ...
            className="h-6 w-full rounded-md border border-emerald-300 bg-white px-1.5 text-[10px] text-slate-800 outline-none focus:ring-1 focus:ring-[color:var(--crm-accent-ring)]"
          />
        ) : (
          <button
            type="button"
