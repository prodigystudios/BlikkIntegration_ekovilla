      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-2 border-b border-[#e0e8dc] bg-white px-4 py-2.5">
          <input
            ...
            className="h-9 min-w-0 flex-1 rounded-lg border border-[#dce4d8] bg-white px-2.5 text-[12.5px] text-slate-600 outline-none transition focus:border-[color:var(--crm-accent)]"
          />
          <input
            value={actorFilter}
            onChange={(e) => setActorFilter(e.target.value)}
            placeholder="Person"
            className="h-9 w-28 rounded-lg border border-[#dce4d8] bg-white px-2.5 text-[12.5px] text-slate-600 outline-none transition focus:border-[color:var(--crm-accent)]"
          />
          <select
            value={actionFilter}
