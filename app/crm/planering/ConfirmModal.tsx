      ...
      <form id={FORM_ID} onSubmit={handleSubmit} className="grid gap-4">
        ...
        <div className="grid gap-1.5">
          <label className="flex items-center gap-2 text-[13px] font-semibold text-slate-700">
            <input type="checkbox" checked={sendEmail} onChange={(e) => setSendEmail(e.target.checked)} disabled={loading} className="h-4 w-4 accent-[color:var(--crm-accent)]" />
            Skicka mejl
          </label>
          <input
            type="email"
        ...
        <div className="grid gap-1.5">
          <label className="flex items-center gap-2 text-[13px] font-semibold text-slate-700">
            <input type="checkbox" checked={sendSms} onChange={(e) => setSendSms(e.target.checked)} disabled={loading} className="h-4 w-4 accent-[color:var(--crm-accent)]" />
            Skicka SMS
          </label>
          <input
            type="tel"
        ...
        <div className="grid gap-1.5">
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-[#dce4d8] bg-white px-3 py-2 text-[13px] text-slate-900 outline-none transition focus:border-[color:var(--crm-accent)] focus:ring-2 focus:ring-[color:var(--crm-accent-ring)] disabled:bg-slate-50 disabled:text-slate-400"
          />
        </div>
      </form>
    </CrmModal>
